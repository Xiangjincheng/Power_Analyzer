...
#define I2C_MSGSTAT_SEND_END          0x0025
#define I2C_MSGSTAT_RESTART           0x0022
#define I2C_MSGSTAT_READ_BUSY         0x0023
#define I2C_MSGSTAT_READ_END          0x0024         
#define I2C_MSGSTAT_READ_FINISH		  0x0026	
// Generic defines
#define I2C_TRUE  1
#define I2C_FALSE 0
#define I2C_YES   1
...
#define First  1 //flash to eeprom 
#define Second 2
#define Third  3 ////sram to eeprom 系统参数
#define Fourth 4 ////sram to eeprom 谐波结构参数
#define Fifth  5
...
struct I2CMSG {
  ...
  Uint16 MemoryHighAddr;		// RTC address of data associated with msg (high byte)
  Uint16 MemoryLowAddr;			// RTC address of data associated with msg (low byte)
