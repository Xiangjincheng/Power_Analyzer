...
{
	EQep1Regs.QUPRD=1500000; //150MHz 单位定时器为100Hz
	EQep1Regs.QDECCTL.bit.QSRC = 0; //正交计数
	EQep1Regs.QEPCTL.bit.FREE_SOFT = 2;
	EQep1Regs.QEPCTL.bit.PCRM = 00; //PCRM = 0 模式，发生索引事件

	EQep1Regs.QEPCTL.bit.UTE = 1; //单位定时器使能
	EQep1Regs.QEPCTL.bit.QCLM = 1;//定时器超时时 锁存
	EQep1Regs.QPOSMAX = 0x2710;   //2500P/R  乘4  一万 2710
